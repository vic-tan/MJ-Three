...
public class ViewAnimator<T extends Resourceble> {
    ...
    public void showMenuContent() {
        ...
        for (int i = 0; i < size; i++) {
            ...
            setImageContent(list.get(i), ((ImageView) viewMenu.findViewById(R.id.menu_item_image)));
    ...
    public void setImageContent(Resourceble resourceble, ImageView imageView) {
        if (resourceble.getImageRes() == 0) {
            if (resourceble.getImageDrawable() != null)
                imageView.setImageDrawable(resourceble.getImageDrawable());
        } else {
